    ...
    public static Object[][] objectTestData(Method method) {
        ...
        if (method.getName().equals("verifyThatUserShouldBuildYourOwnComputerAndAddToCartSuccessfully")){
             data = new Object[][]{
                    ...
                    {"2.5 GHz Intel Pentium Dual-Core E2200 [+15.00]", "4GB [+20.00]", "400 GB [+100.00]", "Ubuntu", "Acrobat Reader [+10.00]"},
                    {"2.5 GHz Intel Pentium Dual-Core E2200 [+15.00]", "8GB [+60.00]", "320 GB", "Windows 10 [+60.00]", "Total Commander [+5.00]"}
            };
